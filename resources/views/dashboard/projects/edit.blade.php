        ...
        <form method="POST" action="/dashboard/projects/{{ $project->id }}" class="mb-5" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('jenis') is-invalid @enderror" id="jenis" name="jenis"
                    required autofocus value="{{ old('jenis', $project->jenis) }}">
                @error('jenis')
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control  @error('qty') is-invalid @enderror" id="qty"
                    name="qty" required value="{{ old('qty', $project->qty) }}">
                @error('qty')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            <div class="mb-3">
                ...
                <input type="text" class="form-control  @error('keterangan') is-invalid @enderror" id="keterangan"
                    name="keterangan" required value="{{ old('keterangan', $project->keterangan) }}">
                @error('keterangan')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            <div class="mb-3">
                ...
                <input type="text" class="form-control  @error('perbaikan') is-invalid @enderror" id="perbaikan"
                    name="perbaikan" required value="{{ old('perbaikan', $project->perbaikan) }}">
                @error('perbaikan')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            <div class="mb-3">
                ...
                <input type="text" class="form-control  @error('status') is-invalid @enderror" id="status"
                    name="status" required value="{{ old('status', $project->status) }}">
                @error('status')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="hidden" name="oldImage" value="{{ $project->sebelum }}">
                @if ($project->sebelum)
                <img src="{{ asset('storage/' . $project->sebelum) }}" class="img-preview img-fluid mb-3 col-sm-5 d-block">
                @else
            ...
            <div class="mb-3">
                ...
                <input type="hidden" name="oldImage" value="{{ $project->pengerjaan }}">
                @if ($project->pengerjaan)
                <img src="{{ asset('storage/' . $project->pengerjaan) }}" class="img-preview1 img-fluid mb-3 col-sm-5 d-block">
                @else
            ...
            <div class="mb-3">
                ...
                <input type="hidden" name="oldImage" value="{{ $project->sesudah }}">
                @if ($project->sesudah)
                <img src="{{ asset('storage/' . $project->sesudah) }}" class="img-preview2 img-fluid mb-3 col-sm-5 d-block">
                @else
